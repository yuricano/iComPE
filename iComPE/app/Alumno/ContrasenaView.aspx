<%@ Page Title="" Language="C#" MasterPageFile="~/Alumno.master" AutoEventWireup="true" CodeFile="ContrasenaView.aspx.cs" Inherits="app_Alumno_ContrasenaView" %>
                    ...
                    <div class="large-12 columns">
                        <div class="row">
                            ...
                            <div class="medium-4 columns">
                                <label>
                                    Contraseña actual
                                    <asp:TextBox runat="server" ID="txtActual" TextMode="Password"></asp:TextBox>
                                </label>
                            </div>
                            ...
                            <div class="medium-4 columns">
                                <label>
                                    Nueva contraseña
                                    <asp:TextBox runat="server" ID="txtNueva" TextMode="Password"></asp:TextBox>
                                </label>
                            </div>
                            ...
                            <div class="medium-4 columns">
                                <label>
                                    ...
                                    <asp:TextBox runat="server" ID="txtConfirma" TextMode="Password"></asp:TextBox>
                                </label>
                            </div>
