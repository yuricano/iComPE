...
public partial class app_Administracion_PagosWeb : System.Web.UI.Page
{
    ...
    protected void gvDatos_OnSelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        Application["admin"] = "1";
        Response.Redirect("~/app/Administracion/AdminAlumnoPagoView.aspx");
    }
    ...
    {
        Log._Log(Convert.ToInt32(Session["id"]), "app_Administracion_PagosWeb", sMensaje);
