<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" 
    CodeFile="Mensaje.aspx.cs" Inherits="app_Administracion_Mensaje" 
            ...
            <div class="box-body">
                ...
                <div class="row">
                    <div class="large-12 columns">
                        <asp:Button runat="server" Text="Agregar Mensaje" ID="btAgregar"
                        ...
                        <br />
                            ...
                            <asp:GridView runat="server" ID="gvDatos" ShowHeaderWhenEmpty="True" AutoGenerateColumns="False"
                                ...
                                <Columns>
                                <asp:BoundField HeaderText="idmensaje" DataField="idmensaje">
                                ...
                                <asp:BoundField HeaderText="idtipousuario" DataField="idtipousuario">
                                    <HeaderStyle HorizontalAlign="Left" />
                                </asp:BoundField>
                                <asp:BoundField HeaderText="usuariotipo" DataField="usuariotipo">
                                    <HeaderStyle HorizontalAlign="Left" />
                                </asp:BoundField>
